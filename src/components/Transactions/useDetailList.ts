...
const getDetailFieldList: any = (productLabel = 'Prodotto') => [
  { label: 'Data e ora', id: 'trxChargeDate', type: TYPE_TEXT.Text },
  { label: productLabel, id: 'additionalProperties.productName', type: TYPE_TEXT.Text },
