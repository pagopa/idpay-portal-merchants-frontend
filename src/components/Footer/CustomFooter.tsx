...
const FOOTER_LINKS = {
    ...
    PRIVACY: 'https://welfare.cstar.pagopa.it/portale-esercenti/privacy-policy',
    ...
    TERMS_AND_CONDITIONS: 'https://welfare.cstar.pagopa.it/portale-esercenti/terms-of-service',
