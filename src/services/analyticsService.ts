...
export const MIXPANEL_EVENTS = {
  ...
  INITIATIVE_ADHERENCE_START: 'IDPAY_INITIATIVE_ADHERENCE_UX_START',
  INITIATIVE_ADHERENCE_SUCCESS: 'IDPAY_INITIATIVE_ADHERENCE_UX_SUCCESS',
  IBAN_EDIT_START: 'IDPAY_IBAN_EDIT_UX_START',
  IBAN_EDIT_SUCCESS: 'IDPAY_IBAN_EDIT_UX_SUCCESS',
  OPERATIVE_EMAIL_EDIT_START: 'IDPAY_OPERATIVE_EMAIL_EDIT_UX_START',
  OPERATIVE_EMAIL_EDIT_SUCCESS: 'IDPAY_OPERATIVE_EMAIL_EDIT_UX_SUCCESS',
} as const;
